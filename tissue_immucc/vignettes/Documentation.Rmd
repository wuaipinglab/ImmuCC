...
-----------------------------------------------------------------
	...
	# Introduction
	The tissue specific computational model predicted the relative proportion of immune cell with a series of tissue specific training signature matrix.
	...
	Raw fastq format sequencing data should be preprocessed into the expression matrix. Six major steps were included in preprocessing the data. 
(1)	Quality control;
