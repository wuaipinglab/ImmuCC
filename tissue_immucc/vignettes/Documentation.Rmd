...
Here, six major steps were included to preprocess the raw data. 
(1)	Quality control;
...
(6)	Normalization. Subtypes of T cell receptor and B cell receptor genes were merged into major families and the raw expression matrix were normalized with the quantile normalization method.
...
Command for data preprocessing is as below:
...
E.g. To estimate immune cell proportion from the transcriptome data of lung, the lung specific signature matrix was used as the training data. As the sample transcriptome data have been normaliazed during data preprocessing steps, it will be not necessary to normalize it again.
